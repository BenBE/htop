...
//      meter->values[i] = 100.0 * timeDiff / (1000 * 1000) / monotonictimeDelta;
   }

//   meter->values[ARRAYSIZE(GPUMeter_engineData)] = 100.0 * saturatingSub(this->curResidueTime, this->prevResidueTime) / (1000 * 1000) / monotonictimeDelta;
